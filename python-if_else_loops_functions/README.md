...
* **8. islower**
  * [8-islower.py](./8-islower.py): Python function that checks for lowercase characters.
  * Returns `True` if `c` is lowercase, `False` otherwise.
  * Without importing modules or using `str.upper()` or `str.isupper()`.
* **9. To uppercase**
  * [9-uppercase.py](./9-uppercase.py): Python function that prints a string in  uppercase followed by a new line. 
 * Using no more than two `print` functions and one loop. 
 * Without importing modules or using `str.upper()` or `str.isupper()`.
* **10. There are only 3 colors, 10 digits, and 7 notes; its what we do with them that's important**
  * [10-print_last_digit.py](./10-print_last_digit.py): Python function that prints the last  digit of a number.
  * Returns the value of the last digit.
  * Without importing modules.
* **11. a + b**
  * [11-add.py](./11-add.py): Python function that returns the addition of two integers. 
 * Without importing modules.
* **12. a ^ b** 
 * [12-pow.py](./12-pow.py): Python function that returns `a` to the power of `b`. 
 * Without importing modules.
* **13. Fizz Buzz**
  * [13-fizzbuzz.py](./12-fizzbuzz.py): Python function that prints the numbers from  `1` to `100` followed by a space.   * For multiples of three, `Fizz` is printed instead of the number. 
